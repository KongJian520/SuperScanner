...
#[tauri::command]
pub async fn restart_task(address: String, id: String, clear_logs: Option<bool>, start_now: Option<bool>, use_tls: Option<bool>) -> Result<dto::TaskDto, String> {
    ...
    let resp = client.restart_task(req).await.map_err(|e| e.to_string())?;
    let task = resp.into_inner();
